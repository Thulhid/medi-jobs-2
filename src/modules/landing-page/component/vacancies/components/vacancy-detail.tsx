...
interface Vacancy {
  ...
  hospital: { id: number; name: string; logo: string; description: string };
...
export const PublicVacancyDetail=({ id }: { id: string }) => {
  ...
  return (
    <section className=" w-full ">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 p-2">
        ...
        {/* <div className=" items-start gap-4 mb-6 hidden md:flex">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600 mt-1 flex flex-col gap-y-2">
              <span>
